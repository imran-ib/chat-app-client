...
export type UserWhereInput = {
  ...
  MediaSender?: Maybe<UsersMediaListRelationFilter>;
  MediaReceiver?: Maybe<UsersMediaListRelationFilter>;
  createdAt?: Maybe<DateTimeFilter>;
  updatedAt?: Maybe<DateTimeFilter>;
  Friends?: Maybe<FriendsListRelationFilter>;
};
...
export type MessagesWhereInput = {
  ...
  createdAt?: Maybe<DateTimeFilter>;
  updatedAt?: Maybe<DateTimeFilter>;
  UsersMedia?: Maybe<UsersMediaListRelationFilter>;
};
...
export type UsersMediaListRelationFilter = {
  every?: Maybe<UsersMediaWhereInput>;
  some?: Maybe<UsersMediaWhereInput>;
  none?: Maybe<UsersMediaWhereInput>;
};
...
export type UsersMediaWhereInput = {
  AND?: Maybe<Array<UsersMediaWhereInput>>;
  OR?: Maybe<Array<UsersMediaWhereInput>>;
  NOT?: Maybe<Array<UsersMediaWhereInput>>;
  id?: Maybe<IntFilter>;
  ...
  Message?: Maybe<MessagesWhereInput>;
  MessageId?: Maybe<IntFilter>;
  otherUser?: Maybe<UserWhereInput>;
  OtherUserId?: Maybe<IntFilter>;
  createdAt?: Maybe<DateTimeFilter>;
  updatedAt?: Maybe<DateTimeFilter>;
};
...
export type UsersQuery = (
  ...
  & { users: Array<(
    { __typename?: 'User' }
    & Pick<User, 'id' | 'username' | 'email' | 'avatar' | 'isActive' | 'lastTyped' | 'lastSeen'>
  )> }
);
...
export type CreateUserMutation = (
  ...
  & { CreateUser: (
    ...
    & { user: (
      { __typename?: 'User' }
      & Pick<User, 'id' | 'username' | 'avatar' | 'email' | 'lastTyped' | 'lastSeen'>
    ) }
  ) }
);
...
export type PasswordLoginMutation = (
  ...
  & { PasswordLogin: (
    ...
    & { user: (
      { __typename?: 'User' }
      & Pick<User, 'id' | 'email' | 'lastTyped' | 'lastSeen'>
    ) }
  ) }
);
...
export type VerifyOptMutation = (
  ...
  & { ValidateOTP: (
    ...
    & { user: (
      { __typename?: 'User' }
      & Pick<User, 'id' | 'avatar' | 'username' | 'lastTyped' | 'lastSeen'>
    ) }
  ) }
);
...
export type GetUsersQuery = (
  ...
  & { GetUsers: Array<(
    { __typename?: 'User' }
    & Pick<User, 'id' | 'username' | 'avatar' | 'lastTyped' | 'lastSeen'>
  )> }
);
...
export type LastSeenMutation = (
  { __typename?: 'Mutation' }
  & Pick<Mutation, 'UserLastSeen'>
);
...
export type OtherUserQuery = (
  ...
  & { OtherUser: (
    { __typename?: 'User' }
    & Pick<User, 'id' | 'username' | 'avatar' | 'email' | 'isActive' | 'lastSeen' | 'lastTyped'>
  ) }
);
...
export type GetUsersMediaQueryVariables = Exact<{ [key: string]: never; }>;
...
export const LastSeenDocument = gql`
  ...
  UserLastSeen
    ...
    `;
export type LastSeenMutationFn = Apollo.MutationFunction<LastSeenMutation, LastSeenMutationVariables>;
 ...
 * });
 */
export function useLastSeenMutation(baseOptions?: Apollo.MutationHookOptions<LastSeenMutation, LastSeenMutationVariables>) {
        return Apollo.useMutation<LastSeenMutation, LastSeenMutationVariables>(LastSeenDocument, baseOptions);
      }
...
export type LastSeenMutationOptions = Apollo.BaseMutationOptions<LastSeenMutation, LastSeenMutationVariables>;
...
export function useOtherUserQuery(baseOptions?: Apollo.QueryHookOptions<OtherUserQuery, OtherUserQueryVariables>) {
        return Apollo.useQuery<OtherUserQuery, OtherUserQueryVariables>(OtherUserDocument, baseOptions);
      }
export function useOtherUserLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<OtherUserQuery, OtherUserQueryVariables>) {
          return Apollo.useLazyQuery<OtherUserQuery, OtherUserQueryVariables>(OtherUserDocument, baseOptions);
        }
...
export const GetUsersMediaDocument = gql`
    query GetUsersMedia {
  GetUsersMedia {
    id
    image
...
/**
 * __useGetUsersMediaQuery__
 *
 * To run a query within a React component, call `useGetUsersMediaQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetUsersMediaQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetUsersMediaQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetUsersMediaQuery(baseOptions?: Apollo.QueryHookOptions<GetUsersMediaQuery, GetUsersMediaQueryVariables>) {
        return Apollo.useQuery<GetUsersMediaQuery, GetUsersMediaQueryVariables>(GetUsersMediaDocument, baseOptions);
      }
export function useGetUsersMediaLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetUsersMediaQuery, GetUsersMediaQueryVariables>) {
          return Apollo.useLazyQuery<GetUsersMediaQuery, GetUsersMediaQueryVariables>(GetUsersMediaDocument, baseOptions);
        }
